...
function generarMetricas(rows, titulo) {
  ...
  rows.forEach(r => {
    ...
    // Agrupación por COMISIONISTA/CANAL (SUBTAL). El formato nuevo de megatabla no trae campo
    // de operador/usuario; el comisionista es el corte con sentido de negocio.
    const u = canalLabel(r.SUBTAL);
